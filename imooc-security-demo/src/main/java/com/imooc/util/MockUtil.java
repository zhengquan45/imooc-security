...
public class MockUtil {
    ...
    public static String []brands="三星,大华,TCL,创维,索尼,优色,安立信,沧龙,明亿科,星辰,币币迪,航嘉,LG,华为,OPPO,vivo,苹果,三星,荣耀,小米,一加,魅族,realme,努比亚,联想,金立,中兴,Moto,锤子科技,360,国美手机,夏普,华硕,美图,诺基亚,HTC8848,SUGAR,黑莓,海信,AGM,红米,黑鲨,索尼,移动ROGLG,谷歌,酷派".split(",");
    /**
     * 方法描述：调用mockJs生成模拟数据.
